...
export const ADAPTERS: readonly Adapter[] = [
  ...
  // secrets
  adapter({ kind: "secrets", name: "doppler", implemented: true, verified: true, needsEnv: [], needsCmd: ["doppler"], supports: ["bootstrap", "has", "get", "set", "sync_local", "ci_token", "export_env"], secretsMode: "doppler", residency: "US" }),
  adapter({ kind: "secrets", name: "infisical", implemented: true, verified: false, needsEnv: ["INFISICAL_PROJECT_ID", "INFISICAL_API_URL"], optionalEnv: ["INFISICAL_TOKEN", "INFISICAL_ENV"], needsCmd: ["infisical"], supports: ["bootstrap", "has", "get", "set", "sync_local", "export_env"], secretsMode: "env", humanGate: "create the Infisical project and a machine identity for CI; set INFISICAL_PROJECT_ID", residency: "EU" }),
  // backend
