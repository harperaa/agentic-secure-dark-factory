...
export const ADAPTERS: readonly Adapter[] = [
  ...
  // review
  adapter({ kind: "review", name: "greptile", implemented: true, verified: false, needsEnv: ["GREPTILE_BOT_LOGIN"], needsCmd: ["gh"], supports: ["wait_for_review"], humanGate: "install the Greptile GitHub App on the product repository (or account-wide if the account holds only factory products); set review=none explicitly where it is absent; verify data-processing terms for EU projects" }),
